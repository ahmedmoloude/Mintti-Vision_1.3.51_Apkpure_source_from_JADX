...
class BarConfig {
    ...
    private int getActionBarHeight(Activity activity) {
        ...
        View findViewById = activity.getWindow().findViewById(C1459R.C1460id.action_bar_container);
    ...
    private int getInternalDimensionSize(Context context, String str) {
        try {
            int identifier = Resources.getSystem().getIdentifier(str, "dimen", Constants.f840OS);
            if (identifier > 0) {

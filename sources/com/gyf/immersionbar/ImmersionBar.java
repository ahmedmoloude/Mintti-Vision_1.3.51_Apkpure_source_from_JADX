...
public final class ImmersionBar implements ImmersionCallback {
    ...
    private int initBarAboveLOLLIPOP(int i) {
        ...
        this.mWindow.clearFlags(PagedChannelRandomAccessSource.DEFAULT_TOTAL_BUFSIZE);
    ...
    private void initBarBelowLOLLIPOP() {
        this.mWindow.addFlags(PagedChannelRandomAccessSource.DEFAULT_TOTAL_BUFSIZE);
        setupStatusBarView();
    ...
    static /* synthetic */ class C14572 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.gyf.immersionbar.ImmersionBar.C14572.<clinit>():void");
        }
    }

    private int hideBar(int i) {
        if (Build.VERSION.SDK_INT >= 16) {
            int i2 = C14572.$SwitchMap$com$gyf$immersionbar$BarHide[this.mBarParams.barHide.ordinal()];
            if (i2 == 1) {
                i |= 518;
            } else if (i2 == 2) {
                i |= 1028;
    ...
    public static void setTitleBar(Activity activity, final int i, View... viewArr) {
        if (Build.VERSION.SDK_INT >= 19 && activity != null) {
            ...
            for (final View view : viewArr) {
                if (view != null) {
                    final Integer num = (Integer) view.getTag(C1459R.C1460id.immersion_fits_layout_overlap);
                    if (num == null) {
                        num = 0;
                    }
                    if (num.intValue() != i) {
                        view.setTag(C1459R.C1460id.immersion_fits_layout_overlap, Integer.valueOf(i));
    ...
    public static void setTitleBarMarginTop(Activity activity, int i, View... viewArr) {
        if (Build.VERSION.SDK_INT >= 19 && activity != null) {
            ...
            for (View view : viewArr) {
                if (view != null) {
                    Integer num = (Integer) view.getTag(C1459R.C1460id.immersion_fits_layout_overlap);
                    if (num == null) {
                        num = 0;
                    }
                    if (num.intValue() != i) {

...
public class RequestManager implements LifecycleListener, ModelTypes<RequestBuilder<Drawable>> {
    ...
    public RequestBuilder<Bitmap> asBitmap() {
        return mo13288as(Bitmap.class).apply((BaseRequestOptions<?>) DECODE_TYPE_BITMAP);
    }

    public RequestBuilder<GifDrawable> asGif() {
        return mo13288as(GifDrawable.class).apply((BaseRequestOptions<?>) DECODE_TYPE_GIF);
    }

    public RequestBuilder<Drawable> asDrawable() {
        return mo13288as(Drawable.class);
    }
    ...
    public RequestBuilder<File> downloadOnly() {
        return mo13288as(File.class).apply((BaseRequestOptions<?>) DOWNLOAD_ONLY_OPTIONS);
    }
    ...
    public RequestBuilder<File> asFile() {
        return mo13288as(File.class).apply((BaseRequestOptions<?>) RequestOptions.skipMemoryCacheOf(true));
    }

    /* renamed from: as */
    public <ResourceType> RequestBuilder<ResourceType> mo13288as(Class<ResourceType> cls) {

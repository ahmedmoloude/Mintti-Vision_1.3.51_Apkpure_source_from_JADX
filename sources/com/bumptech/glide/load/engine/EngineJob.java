...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0051, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallResourceReady(r4, r1.f308cb));
     */
    ...
    public void notifyCallbacksOfResult() {
        ...
        L_0x004b:
            ...
            com.bumptech.glide.request.ResourceCallback r1 = r1.f308cb
            r3.<init>(r1)
            r2.execute(r3)
            goto L_0x004b
        L_0x0064:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x003f, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallLoadFailed(r4, r1.f308cb));
     */
    ...
    private class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f306cb;

        CallLoadFailed(ResourceCallback resourceCallback) {
            this.f306cb = resourceCallback;
        }

        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f306cb)) {
                    EngineJob.this.callCallbackOnLoadFailed(this.f306cb);
                }
    ...
    private class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f307cb;

        CallResourceReady(ResourceCallback resourceCallback) {
            this.f307cb = resourceCallback;
        }

        public void run() {
            synchronized (EngineJob.this) {
                if (EngineJob.this.cbs.contains(this.f307cb)) {
                    EngineJob.this.engineResource.acquire();
                    EngineJob.this.callCallbackOnResourceReady(this.f307cb);
                    EngineJob.this.removeCallback(this.f307cb);
                }
                EngineJob.this.decrementPendingCallbacks();
            }
        }
    ...
    static final class ResourceCallbackAndExecutor {
        ...
        /* renamed from: cb */
        final ResourceCallback f308cb;
        final Executor executor;

        ResourceCallbackAndExecutor(ResourceCallback resourceCallback, Executor executor2) {
            this.f308cb = resourceCallback;
            this.executor = executor2;
        }

        public boolean equals(Object obj) {
            if (obj instanceof ResourceCallbackAndExecutor) {
                return this.f308cb.equals(((ResourceCallbackAndExecutor) obj).f308cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f308cb.hashCode();
        }
    }

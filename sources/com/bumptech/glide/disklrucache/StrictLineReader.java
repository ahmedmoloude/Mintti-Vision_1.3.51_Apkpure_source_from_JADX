...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f296CR = 13;

    /* renamed from: LF */
    private static final byte f297LF = 10;
    private byte[] buf;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f298in) {
            if (this.buf != null) {
                ...
                C09871 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f298in;
        byte[] bArr = this.buf;

...
/* renamed from: com.kl.commonbase.views.ecg.EcgWaveView */
public class EcgWaveView extends View {
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.f853xS = EcgBackgroundView.f852xS;
        ...
        this.dataSpacing = this.f853xS / f2;
    ...
    private float getPointY(int i) {
        try {
            if (this.sampleRate == 512) {
                return (float) (((double) this.mViewHalfHeight) + (((((((double) this.dataList.get(i).floatValue()) * 18.3d) / 128.0d) * ((double) this.f853xS)) / 100.0d) * ((double) this.gain)));
            }
            float calcRealMv = calcRealMv(this.dataList.get(i).floatValue());
            return this.mViewHalfHeight + (calcRealMv * this.f853xS * this.gain * 10.0f);
    ...
    public void setPagerSpeed(int i) {
        this.pagerSpeed = i;
        float f = ((float) this.sampleRate) / (((float) i) * 25.0f);
        this.allDataSize = (int) (this.totalLattices * f);
        this.dataSpacing = this.f853xS / f;
        if (!this.dataList.isEmpty()) {
            postInvalidate();
        }
    }
    ...
    public void setSampleRate(int i) {
        this.sampleRate = i;
        float f = ((float) i) / (((float) this.pagerSpeed) * 25.0f);
        this.allDataSize = (int) (this.totalLattices * f);
        this.dataSpacing = this.f853xS / f;
    }
}

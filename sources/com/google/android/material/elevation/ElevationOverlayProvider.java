...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this.elevationOverlayEnabled = MaterialAttributes.resolveBoolean(context, C1077R.attr.elevationOverlayEnabled, false);
        this.elevationOverlayColor = MaterialColors.getColor(context, C1077R.attr.elevationOverlayColor, 0);
        this.colorSurface = MaterialColors.getColor(context, C1077R.attr.colorSurface, 0);
    ...
    public float calculateOverlayAlphaFraction(float f) {
        ...
        return Math.min(((((float) Math.log1p((double) (f / f2))) * FORMULA_MULTIPLIER) + 2.0f) / 100.0f, 1.0f);
    }

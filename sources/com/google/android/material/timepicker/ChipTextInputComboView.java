...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        Chip chip2 = (Chip) from.inflate(C1077R.layout.material_time_chip, this, false);
        this.chip = chip2;
        TextInputLayout textInputLayout2 = (TextInputLayout) from.inflate(C1077R.layout.material_time_input, this, false);
        ...
        this.label = (TextView) findViewById(C1077R.C1081id.material_label);

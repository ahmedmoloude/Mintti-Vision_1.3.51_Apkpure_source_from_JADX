...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec2) {
        ...
        if (motionSpec2.hasPropertyValues(HtmlTags.WIDTH)) {
            arrayList.add(motionSpec2.getAnimator(HtmlTags.WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec2.hasPropertyValues(HtmlTags.HEIGHT)) {
            arrayList.add(motionSpec2.getAnimator(HtmlTags.HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }

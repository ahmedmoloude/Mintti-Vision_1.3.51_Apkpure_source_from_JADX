...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C1077R.C1083style.Widget_MaterialComponents_ExtendedFloatingActionButton_Icon;
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, HtmlTags.HEIGHT) {
    ...
    static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, HtmlTags.WIDTH) {
        public void set(View view, Float f) {
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1077R.attr.extendedFloatingActionButtonStyle);
    }
    ...
    public ExtendedFloatingActionButton(android.content.Context r17, android.util.AttributeSet r18, int r19) {
        /*
            ...
            r1.<init>(r14, r7)
            r0.behavior = r1
            int[] r3 = com.google.android.material.C1077R.styleable.ExtendedFloatingActionButton
            int[] r6 = new int[r10]
            r1 = r14
            r2 = r18
            r4 = r19
            ...
            int r2 = com.google.android.material.C1077R.styleable.ExtendedFloatingActionButton_showMotionSpec
            ...
            int r3 = com.google.android.material.C1077R.styleable.ExtendedFloatingActionButton_hideMotionSpec
            ...
            int r4 = com.google.android.material.C1077R.styleable.ExtendedFloatingActionButton_extendMotionSpec
            ...
            int r5 = com.google.android.material.C1077R.styleable.ExtendedFloatingActionButton_shrinkMotionSpec
            ...
            int r6 = com.google.android.material.C1077R.styleable.ExtendedFloatingActionButton_collapsedSize
            r15 = -1
    ...
    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public ExtendedFloatingActionButtonBehavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1077R.styleable.ExtendedFloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = obtainStyledAttributes.getBoolean(C1077R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoHide, false);
            this.autoShrinkEnabled = obtainStyledAttributes.getBoolean(C1077R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoShrink, true);
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return this.extending ? C1077R.animator.mtrl_extended_fab_change_size_expand_motion_spec : C1077R.animator.mtrl_extended_fab_change_size_collapse_motion_spec;
        }

        public AnimatorSet createAnimator() {
            MotionSpec currentMotionSpec = getCurrentMotionSpec();
            if (currentMotionSpec.hasPropertyValues(HtmlTags.WIDTH)) {
                PropertyValuesHolder[] propertyValues = currentMotionSpec.getPropertyValues(HtmlTags.WIDTH);
                propertyValues[0].setFloatValues(new float[]{(float) ExtendedFloatingActionButton.this.getWidth(), (float) this.size.getWidth()});
                currentMotionSpec.setPropertyValues(HtmlTags.WIDTH, propertyValues);
            }
            if (currentMotionSpec.hasPropertyValues(HtmlTags.HEIGHT)) {
                PropertyValuesHolder[] propertyValues2 = currentMotionSpec.getPropertyValues(HtmlTags.HEIGHT);
                propertyValues2[0].setFloatValues(new float[]{(float) ExtendedFloatingActionButton.this.getHeight(), (float) this.size.getHeight()});
                currentMotionSpec.setPropertyValues(HtmlTags.HEIGHT, propertyValues2);
            }
    ...
    class ShowStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C1077R.animator.mtrl_extended_fab_show_motion_spec;
        }
    ...
    class HideStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            return C1077R.animator.mtrl_extended_fab_hide_motion_spec;
        }

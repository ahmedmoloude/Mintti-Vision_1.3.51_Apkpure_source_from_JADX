...
public class ViewUtils {
    ...
    public static class RelativePadding {
        ...
        public RelativePadding(RelativePadding relativePadding) {
            ...
            this.f2168top = relativePadding.f2168top;
            this.end = relativePadding.end;
            this.bottom = relativePadding.bottom;
        }

        public void applyToView(View view) {
            ViewCompat.setPaddingRelative(view, this.start, this.f2168top, this.end, this.bottom);
        }
    }
    ...
    public static void doOnApplyWindowInsets(View view, AttributeSet attributeSet, int i, int i2, final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        TypedArray obtainStyledAttributes = view.getContext().obtainStyledAttributes(attributeSet, C1077R.styleable.Insets, i, i2);
        final boolean z = obtainStyledAttributes.getBoolean(C1077R.styleable.Insets_paddingBottomSystemWindowInsets, false);
        final boolean z2 = obtainStyledAttributes.getBoolean(C1077R.styleable.Insets_paddingLeftSystemWindowInsets, false);
        final boolean z3 = obtainStyledAttributes.getBoolean(C1077R.styleable.Insets_paddingRightSystemWindowInsets, false);

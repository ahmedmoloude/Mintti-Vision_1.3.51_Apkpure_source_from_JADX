...
public class AspectRatioTextView extends AppCompatTextView {
    ...
    public AspectRatioTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        init(context.obtainStyledAttributes(attributeSet, C2385R.styleable.ucrop_AspectRatioTextView));
    }
    ...
    private void init(TypedArray typedArray) {
        setGravity(1);
        this.mAspectRatioTitle = typedArray.getString(C2385R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_title);
        this.mAspectRatioX = typedArray.getFloat(C2385R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_x, 0.0f);
        float f = typedArray.getFloat(C2385R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_y, 0.0f);
        ...
        this.mDotSize = getContext().getResources().getDimensionPixelSize(C2385R.dimen.ucrop_size_dot_scale_text_view);
        Paint paint = new Paint(1);
        this.mDotPaint = paint;
        paint.setStyle(Paint.Style.FILL);
        setTitle();
        applyActiveColor(getResources().getColor(C2385R.C2387color.ucrop_color_widget_active));
        typedArray.recycle();
    }
    ...
    private void applyActiveColor(int i) {
        ...
        setTextColor(new ColorStateList(new int[][]{new int[]{16842913}, new int[]{0}}, new int[]{i, ContextCompat.getColor(getContext(), C2385R.C2387color.ucrop_color_widget)}));
    }

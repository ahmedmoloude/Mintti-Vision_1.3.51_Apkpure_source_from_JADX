...
public class UCropView extends FrameLayout {
    ...
    public UCropView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C2385R.layout.ucrop_view, this, true);
        this.mGestureCropImageView = (GestureCropImageView) findViewById(C2385R.C2389id.image_view_crop);
        OverlayView overlayView = (OverlayView) findViewById(C2385R.C2389id.view_overlay);
        this.mViewOverlay = overlayView;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2385R.styleable.ucrop_UCropView);

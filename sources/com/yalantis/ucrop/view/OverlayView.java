...
import com.yalantis.ucrop.C2385R;
...
public class OverlayView extends View {
    ...
    public OverlayView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mTouchPointThreshold = getResources().getDimensionPixelSize(C2385R.dimen.ucrop_default_crop_rect_corner_touch_threshold);
        this.mCropRectMinSize = getResources().getDimensionPixelSize(C2385R.dimen.ucrop_default_crop_rect_min_size);
        this.mCropRectCornerTouchAreaLineLength = getResources().getDimensionPixelSize(C2385R.dimen.ucrop_default_crop_rect_corner_touch_area_line_length);
        init();
    }
    ...
    public void processStyledAttributes(TypedArray typedArray) {
        this.mCircleDimmedLayer = typedArray.getBoolean(C2385R.styleable.ucrop_UCropView_ucrop_circle_dimmed_layer, false);
        int color = typedArray.getColor(C2385R.styleable.ucrop_UCropView_ucrop_dimmed_color, getResources().getColor(C2385R.C2387color.ucrop_color_default_dimmed));
        ...
        this.mShowCropFrame = typedArray.getBoolean(C2385R.styleable.ucrop_UCropView_ucrop_show_frame, true);
        initCropGridStyle(typedArray);
        this.mShowCropGrid = typedArray.getBoolean(C2385R.styleable.ucrop_UCropView_ucrop_show_grid, true);
    }

    private void initCropFrameStyle(TypedArray typedArray) {
        int dimensionPixelSize = typedArray.getDimensionPixelSize(C2385R.styleable.ucrop_UCropView_ucrop_frame_stroke_size, getResources().getDimensionPixelSize(C2385R.dimen.ucrop_default_crop_frame_stoke_width));
        int color = typedArray.getColor(C2385R.styleable.ucrop_UCropView_ucrop_frame_color, getResources().getColor(C2385R.C2387color.ucrop_color_default_crop_frame));
    ...
    private void initCropGridStyle(TypedArray typedArray) {
        int dimensionPixelSize = typedArray.getDimensionPixelSize(C2385R.styleable.ucrop_UCropView_ucrop_grid_stroke_size, getResources().getDimensionPixelSize(C2385R.dimen.ucrop_default_crop_grid_stoke_width));
        int color = typedArray.getColor(C2385R.styleable.ucrop_UCropView_ucrop_grid_color, getResources().getColor(C2385R.C2387color.ucrop_color_default_crop_grid));
        this.mCropGridPaint.setStrokeWidth((float) dimensionPixelSize);
        this.mCropGridPaint.setColor(color);
        this.mCropGridRowCount = typedArray.getInt(C2385R.styleable.ucrop_UCropView_ucrop_grid_row_count, 2);
        this.mCropGridColumnCount = typedArray.getInt(C2385R.styleable.ucrop_UCropView_ucrop_grid_column_count, 2);
    }
}

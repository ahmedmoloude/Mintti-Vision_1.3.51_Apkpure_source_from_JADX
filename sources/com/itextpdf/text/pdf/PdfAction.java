...
public class PdfAction extends PdfDictionary {
    ...
    PdfAction(PdfIndirectReference pdfIndirectReference) {
        put(PdfName.f642S, PdfName.GOTO);
        put(PdfName.f567D, pdfIndirectReference);
    }

    public PdfAction(String str, String str2) {
        put(PdfName.f642S, PdfName.GOTOR);
        put(PdfName.f580F, new PdfString(str));
        put(PdfName.f567D, new PdfString(str2));
    }

    public PdfAction(String str, int i) {
        put(PdfName.f642S, PdfName.GOTOR);
        put(PdfName.f580F, new PdfString(str));
        PdfName pdfName = PdfName.f567D;
    ...
    public PdfAction(int i) {
        put(PdfName.f642S, PdfName.NAMED);
        if (i == 1) {
            put(PdfName.f610N, PdfName.FIRSTPAGE);
        } else if (i == 2) {
            put(PdfName.f610N, PdfName.PREVPAGE);
        } else if (i == 3) {
            put(PdfName.f610N, PdfName.NEXTPAGE);
        } else if (i == 4) {
            put(PdfName.f610N, PdfName.LASTPAGE);
        } else if (i == 5) {
            put(PdfName.f642S, PdfName.JAVASCRIPT);
            put(PdfName.f604JS, new PdfString("this.print(true);\r"));
        } else {
    ...
    public PdfAction(String str, String str2, String str3, String str4) {
        put(PdfName.f642S, PdfName.LAUNCH);
        if (str2 == null && str3 == null && str4 == null) {
            put(PdfName.f580F, new PdfString(str));
            return;
        }
        PdfDictionary pdfDictionary = new PdfDictionary();
        pdfDictionary.put(PdfName.f580F, new PdfString(str));
        if (str2 != null) {
            pdfDictionary.put(PdfName.f623P, new PdfString(str2));
        }
        if (str3 != null) {
            pdfDictionary.put(PdfName.f617O, new PdfString(str3));
        }
        if (str4 != null) {
            pdfDictionary.put(PdfName.f567D, new PdfString(str4));
        }
    ...
    public static PdfAction rendition(String str, PdfFileSpecification pdfFileSpecification, String str2, PdfIndirectReference pdfIndirectReference) throws IOException {
        ...
        pdfAction.put(PdfName.f642S, PdfName.RENDITION);
        pdfAction.put(PdfName.f632R, new PdfRendition(str, pdfFileSpecification, str2));
    ...
    public static PdfAction javaScript(String str, PdfWriter pdfWriter, boolean z) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f642S, PdfName.JAVASCRIPT);
        String str2 = PdfObject.TEXT_UNICODE;
        if (z && str.length() < 50) {
            pdfAction.put(PdfName.f604JS, new PdfString(str, str2));
            ...
            try {
                ...
                pdfAction.put(PdfName.f604JS, pdfWriter.addToBody(pdfStream).getIndirectReference());
            } catch (Exception unused) {
                pdfAction.put(PdfName.f604JS, new PdfString(str));
            }
        } else {
            pdfAction.put(PdfName.f604JS, new PdfString(str));
        }
    ...
    static PdfAction createHide(PdfObject pdfObject, boolean z) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f642S, PdfName.HIDE);
        pdfAction.put(PdfName.f647T, pdfObject);
        if (!z) {
            pdfAction.put(PdfName.f589H, PdfBoolean.PDFFALSE);
        }
        return pdfAction;
    }
    ...
    public static PdfAction createSubmitForm(String str, Object[] objArr, int i) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f642S, PdfName.SUBMITFORM);
        PdfDictionary pdfDictionary = new PdfDictionary();
        pdfDictionary.put(PdfName.f580F, new PdfString(str));
        pdfDictionary.put(PdfName.f587FS, PdfName.URL);
        pdfAction.put(PdfName.f580F, pdfDictionary);
        if (objArr != null) {
    ...
    public static PdfAction createResetForm(Object[] objArr, int i) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f642S, PdfName.RESETFORM);
        if (objArr != null) {
            pdfAction.put(PdfName.FIELDS, buildArray(objArr));
        }
        pdfAction.put(PdfName.FLAGS, new PdfNumber(i));
    ...
    public static PdfAction createImportData(String str) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f642S, PdfName.IMPORTDATA);
        pdfAction.put(PdfName.f580F, new PdfString(str));
        return pdfAction;
    }
    ...
    public static PdfAction gotoLocalPage(int i, PdfDestination pdfDestination, PdfWriter pdfWriter) {
        ...
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f642S, PdfName.GOTO);
        pdfAction.put(PdfName.f567D, pdfDestination2);
        return pdfAction;
    }
    ...
    public static PdfAction gotoLocalPage(String str, boolean z) {
        ...
        pdfAction.put(PdfName.f642S, PdfName.GOTO);
        if (z) {
            pdfAction.put(PdfName.f567D, new PdfName(str));
        } else {
            pdfAction.put(PdfName.f567D, new PdfString(str, PdfObject.TEXT_UNICODE));
        }
        return pdfAction;
    }
    ...
    public static PdfAction gotoRemotePage(String str, String str2, boolean z, boolean z2) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f580F, new PdfString(str));
        pdfAction.put(PdfName.f642S, PdfName.GOTOR);
        if (z) {
            pdfAction.put(PdfName.f567D, new PdfName(str2));
        } else {
            pdfAction.put(PdfName.f567D, new PdfString(str2, PdfObject.TEXT_UNICODE));
        }
        if (z2) {
    ...
    public static PdfAction gotoEmbedded(String str, PdfTargetDictionary pdfTargetDictionary, PdfObject pdfObject, boolean z) {
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f642S, PdfName.GOTOE);
        pdfAction.put(PdfName.f647T, pdfTargetDictionary);
        pdfAction.put(PdfName.f567D, pdfObject);
    ...
    public static PdfAction setOCGstate(ArrayList<Object> arrayList, boolean z) {
        PdfName pdfName;
        PdfAction pdfAction = new PdfAction();
        pdfAction.put(PdfName.f642S, PdfName.SETOCGSTATE);
        PdfArray pdfArray = new PdfArray();

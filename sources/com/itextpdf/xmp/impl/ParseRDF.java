...
public class ParseRDF implements XMPError, XMPConst {
    ...
    private static void rdf_EmptyPropertyElement(com.itextpdf.xmp.impl.XMPMetaImpl r16, com.itextpdf.xmp.impl.XMPNode r17, org.w3c.dom.Node r18, boolean r19) throws com.itextpdf.xmp.XMPException {
        /*
            r0 = r16
        ...
        L_0x00b5:
            ...
            r8 = r18
            r9 = r19
            com.itextpdf.xmp.impl.XMPNode r4 = addChildNode(r0, r4, r8, r1, r9)
            if (r5 != 0) goto L_0x00d2
            if (r6 == 0) goto L_0x00c6
            goto L_0x00d2
        L_0x00c6:
            if (r7 == 0) goto L_0x00e5
            com.itextpdf.xmp.options.PropertyOptions r1 = r4.getOptions()
            r6 = 1
            r1.setStruct(r6)
            r1 = 1
            goto L_0x00e6
    ...
    private static int getRDFTermKind(Node node) {
        ...
        if (HtmlTags.f487LI.equals(localName)) {
            return 9;
        }

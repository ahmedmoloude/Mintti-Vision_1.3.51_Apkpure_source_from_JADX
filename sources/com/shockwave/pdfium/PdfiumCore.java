...
public class PdfiumCore {
    ...
    public PdfDocument.Meta getDocumentMeta(PdfDocument pdfDocument) {
        ...
        synchronized (lock) {
            ...
            meta.keywords = nativeGetDocumentMetaText(pdfDocument.mNativeDocPtr, PdfProperties.KEYWORDS);
            meta.creator = nativeGetDocumentMetaText(pdfDocument.mNativeDocPtr, "Creator");
            meta.producer = nativeGetDocumentMetaText(pdfDocument.mNativeDocPtr, PdfProperties.PRODUCER);

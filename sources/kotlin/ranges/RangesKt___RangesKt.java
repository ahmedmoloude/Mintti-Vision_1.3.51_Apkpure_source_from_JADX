...
class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final byte coerceIn(byte b, byte b2, byte b3) {
        if (b2 > b3) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + b3 + " is less than minimum " + b2 + JwtParser.SEPARATOR_CHAR);
        } else if (b < b2) {
            return b2;
        } else {
            return b > b3 ? b3 : b;
    ...
    public static final short coerceIn(short s, short s2, short s3) {
        if (s2 > s3) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + s3 + " is less than minimum " + s2 + JwtParser.SEPARATOR_CHAR);
        } else if (s < s2) {
            return s2;
        } else {
            return s > s3 ? s3 : s;
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(T t, ClosedFloatingPointRange<T> closedFloatingPointRange) {
        ...
        if (closedFloatingPointRange.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + closedFloatingPointRange + JwtParser.SEPARATOR_CHAR);

...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
                ...
                if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                    while (true) {
                        ...
                        if (str2 == null) {
                            ...
                            return TuplesKt.m1092to(Integer.valueOf(first), str2);
                        }
                    }
                }
            } else {
                ...
                if ((step2 > 0 && first2 <= last2) || (step2 < 0 && last2 <= first2)) {
                    while (true) {
                        ...
                        if (str4 == null) {
                            ...
                            return TuplesKt.m1092to(Integer.valueOf(first2), str4);
                        }
                    }
                }
            }
        ...
        return TuplesKt.m1092to(Integer.valueOf(indexOf$default), str5);
    }
    ...
    public static final boolean toBooleanStrict(String str) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        if (Intrinsics.areEqual((Object) str, (Object) PdfBoolean.TRUE)) {
            return true;
        }
        if (Intrinsics.areEqual((Object) str, (Object) PdfBoolean.FALSE)) {
            return false;
        }
    ...
    public static final Boolean toBooleanStrictOrNull(String str) {
        ...
        return Intrinsics.areEqual((Object) str, (Object) PdfBoolean.FALSE) ? false : null;
    }

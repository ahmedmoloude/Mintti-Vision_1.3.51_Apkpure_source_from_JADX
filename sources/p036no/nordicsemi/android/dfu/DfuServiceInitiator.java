...
public final class DfuServiceInitiator {
    ...
    public static void createDfuNotificationChannel(Context context) {
        NotificationChannel notificationChannel = new NotificationChannel(DfuBaseService.NOTIFICATION_CHANNEL_DFU, context.getString(C2518R.string.dfu_channel_name), 2);
        notificationChannel.setDescription(context.getString(C2518R.string.dfu_channel_description));

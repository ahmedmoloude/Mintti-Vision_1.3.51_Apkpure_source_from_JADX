package p036no.nordicsemi.android.dfu.internal.exception;
...
public class UnknownResponseException extends Exception {
    private static final char[] HEX_ARRAY = {'0', '1', PdfWriter.VERSION_1_2, PdfWriter.VERSION_1_3, PdfWriter.VERSION_1_4, PdfWriter.VERSION_1_5, PdfWriter.VERSION_1_6, PdfWriter.VERSION_1_7, '8', '9', 'A', 'B', 'C', 'D', 'E', 'F'};
    ...
    public static String bytesToHex(byte[] bArr, int i, int i2) {
        ...
        for (int i3 = 0; i3 < min; i3++) {
            ...
            cArr[i4] = cArr2[b >>> 4];
            cArr[i4 + 1] = cArr2[b & BidiOrder.f518B];
        }

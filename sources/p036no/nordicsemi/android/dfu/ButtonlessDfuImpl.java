...
abstract class ButtonlessDfuImpl extends BaseButtonlessDfuImpl {
    ...
    public void performDfu(android.content.Intent r13) throws p036no.nordicsemi.android.dfu.internal.exception.DfuException, p036no.nordicsemi.android.dfu.internal.exception.DeviceDisconnectedException, p036no.nordicsemi.android.dfu.internal.exception.UploadAbortedException {
        /*
            r12 = this;
            java.lang.String r0 = ")"
        ...
        L_0x0044:
            ...
            r9 = -3
            r8.setProgress(r9)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            ...
            byte[] r8 = OP_CODE_ENTER_BOOTLOADER     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            r12.writeOpCode(r6, r8, r7)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            no.nordicsemi.android.dfu.DfuBaseService r6 = r12.mService     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            java.lang.String r8 = "Enter bootloader sent (Op Code = 1)"
            r6.sendLogBroadcast(r10, r8)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            byte[] r6 = r12.readNotificationResponse()     // Catch:{ DeviceDisconnectedException -> 0x0079 }
            goto L_0x007b
        L_0x0079:
            byte[] r6 = r12.mReceivedData     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
        L_0x007b:
            if (r6 == 0) goto L_0x00cd
            int r8 = r12.getStatusCode(r6, r7)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            r9.<init>()     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            r9.append(r2)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            byte r11 = r6[r7]     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            r9.append(r11)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            r9.append(r1)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            r9.append(r8)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            r9.append(r0)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            java.lang.String r9 = r9.toString()     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            r12.logi(r9)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            no.nordicsemi.android.dfu.DfuBaseService r9 = r12.mService     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            ...
            byte r2 = r6[r7]     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            r11.append(r2)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
            ...
            r9.sendLogBroadcast(r10, r0)     // Catch:{ UnknownResponseException -> 0x010d, RemoteDfuException -> 0x00e2 }
        ...
        L_0x00e2:
            ...
            java.lang.String r6 = p036no.nordicsemi.android.error.SecureDfuError.parseButtonlessError(r0)
            r2[r4] = r6
        ...
        L_0x0125:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p036no.nordicsemi.android.dfu.ButtonlessDfuImpl.performDfu(android.content.Intent):void");
    }

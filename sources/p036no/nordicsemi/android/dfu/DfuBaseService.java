...
import p036no.nordicsemi.android.dfu.DfuProgressInfo;
import p036no.nordicsemi.android.dfu.internal.ArchiveInputStream;
import p036no.nordicsemi.android.dfu.internal.HexInputStream;
...
public abstract class DfuBaseService extends IntentService implements DfuProgressInfo.ProgressListener {
    ...
    public void onCreate() {
        super.onCreate();
        DEBUG = isDebug();
        logi("DFU service created. Version: 1.12.0");
        initialize();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:254:0x0469, code lost:
        r4 = r4 & -32769;
        sendLogBroadcast(20, java.lang.String.format(java.util.Locale.US, "Error (0x%02X): %s", new java.lang.Object[]{java.lang.Integer.valueOf(r4), p036no.nordicsemi.android.error.GattError.parseConnectionError(r4)}));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:255:0x048c, code lost:
        r4 = r4 & -16385;
        sendLogBroadcast(20, java.lang.String.format(java.util.Locale.US, "Error (0x%02X): %s", new java.lang.Object[]{java.lang.Integer.valueOf(r4), p036no.nordicsemi.android.error.GattError.parse(r4)}));
     */
    ...
    public void onHandleIntent(android.content.Intent r25) {
        ...
        L_0x00c1:
            ...
            r1.logw(r13)
        L_0x00ce:
            p036no.nordicsemi.android.dfu.UuidHelper.assignCustomUuids(r25)
        ...
        L_0x0199:
            ...
            r2 = r6
            no.nordicsemi.android.dfu.internal.ArchiveInputStream r2 = (p036no.nordicsemi.android.dfu.internal.ArchiveInputStream) r2     // Catch:{ SecurityException -> 0x0191, FileNotFoundException -> 0x018d, SizeValidationException -> 0x0189, IOException -> 0x0185, Exception -> 0x0181 }
        ...
        L_0x02eb:
            ...
            java.lang.String r5 = p036no.nordicsemi.android.error.GattError.parseConnectionError(r5)     // Catch:{ all -> 0x031e }
            r6 = 1
        ...
        L_0x0324:
            ...
            java.lang.String r2 = p036no.nordicsemi.android.error.GattError.parse(r2)     // Catch:{ all -> 0x03b7 }
            r6 = 1
        ...
        L_0x045f:
            ...
            java.lang.String r4 = p036no.nordicsemi.android.error.GattError.parseConnectionError(r4)     // Catch:{ all -> 0x0459 }
            r8 = 1
        ...
        L_0x048c:
            ...
            r9 = 0
            r7[r9] = r8     // Catch:{ all -> 0x0459 }
            java.lang.String r4 = p036no.nordicsemi.android.error.GattError.parse(r4)     // Catch:{ all -> 0x0459 }
            r8 = 1
            r7[r8] = r4     // Catch:{ all -> 0x0459 }
            java.lang.String r4 = java.lang.String.format(r5, r6, r7)     // Catch:{ all -> 0x0459 }
            r5 = 20
        ...
        L_0x05f7:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p036no.nordicsemi.android.dfu.DfuBaseService.onHandleIntent(android.content.Intent):void");
    }
        ...
        if (this.mLastProgress != progress) {
            ...
            if (!this.mDisableNotification) {
                ...
                if (elapsedRealtime - this.mLastNotificationTime >= 250 || -6 == progress || -7 == progress) {
                    ...
                    if (str3 == null) {
                        str3 = getString(C2518R.string.dfu_unknown_name);
                    }
                    ...
                    switch (progress) {
                        case PROGRESS_ABORTED /*-7*/:
                            onlyAlertOnce.setOngoing(false).setContentTitle(getString(C2518R.string.dfu_status_aborted)).setSmallIcon(17301641).setContentText(getString(C2518R.string.dfu_status_aborted_msg)).setAutoCancel(true);
                            break;
                        case PROGRESS_COMPLETED /*-6*/:
                            onlyAlertOnce.setOngoing(false).setContentTitle(getString(C2518R.string.dfu_status_completed)).setSmallIcon(17301641).setContentText(getString(C2518R.string.dfu_status_completed_msg)).setAutoCancel(true).setColor(-16730086);
                            break;
                        case -5:
                            onlyAlertOnce.setOngoing(true).setContentTitle(getString(C2518R.string.dfu_status_disconnecting)).setContentText(getString(C2518R.string.dfu_status_disconnecting_msg, new Object[]{str3})).setProgress(100, 0, true);
                            break;
                        case -4:
                            onlyAlertOnce.setOngoing(true).setContentTitle(getString(C2518R.string.dfu_status_validating)).setContentText(getString(C2518R.string.dfu_status_validating_msg)).setProgress(100, 0, true);
                            break;
                        case -3:
                            onlyAlertOnce.setOngoing(true).setContentTitle(getString(C2518R.string.dfu_status_switching_to_dfu)).setContentText(getString(C2518R.string.dfu_status_switching_to_dfu_msg)).setProgress(100, 0, true);
                            break;
                        case -2:
                            onlyAlertOnce.setOngoing(true).setContentTitle(getString(C2518R.string.dfu_status_starting)).setContentText(getString(C2518R.string.dfu_status_starting_msg)).setProgress(100, 0, true);
                            break;
                        case -1:
                            onlyAlertOnce.setOngoing(true).setContentTitle(getString(C2518R.string.dfu_status_connecting)).setContentText(getString(C2518R.string.dfu_status_connecting_msg, new Object[]{str3})).setProgress(100, 0, true);
                            break;
                        default:
                            if (dfuProgressInfo.getTotalParts() == 1) {
                                str = getString(C2518R.string.dfu_status_uploading);
                            } else {
                                str = getString(C2518R.string.dfu_status_uploading_part, new Object[]{Integer.valueOf(dfuProgressInfo.getCurrentPart()), Integer.valueOf(dfuProgressInfo.getTotalParts())});
                            }
                            onlyAlertOnce.setOngoing(true).setContentTitle(str).setContentText(getString(C2518R.string.dfu_status_uploading_msg, new Object[]{str3})).setProgress(100, progress, false);
                            break;
                    }
    ...
    public void updateProgressNotification(NotificationCompat.Builder builder, int i) {
        if (i != -7 && i != -6) {
            ...
            builder.addAction(C2518R.C2520drawable.ic_action_notify_cancel, getString(C2518R.string.dfu_action_abort), PendingIntent.getBroadcast(this, 1, intent, i2));
        }
    }
    ...
    private void report(int i) {
        ...
        if (!this.mDisableNotification) {
            ...
            if (str2 == null) {
                str2 = getString(C2518R.string.dfu_unknown_name);
            }
            NotificationCompat.Builder autoCancel = new NotificationCompat.Builder((Context) this, NOTIFICATION_CHANNEL_DFU).setSmallIcon(17301640).setOnlyAlertOnce(true).setColor(SupportMenu.CATEGORY_MASK).setOngoing(false).setContentTitle(getString(C2518R.string.dfu_status_error)).setSmallIcon(17301641).setContentText(getString(C2518R.string.dfu_status_error_msg)).setAutoCancel(true);
            Intent intent = new Intent(this, getNotificationTarget());
            intent.addFlags(268435456);
    ...
    private void startForeground() {
        NotificationCompat.Builder ongoing = new NotificationCompat.Builder((Context) this, NOTIFICATION_CHANNEL_DFU).setSmallIcon(17301640).setContentTitle(getString(C2518R.string.dfu_status_foreground_title)).setContentText(getString(C2518R.string.dfu_status_foreground_content)).setColor(-7829368).setPriority(-1).setOngoing(true);

...
import kotlin.UByte;
import p036no.nordicsemi.android.dfu.BaseCustomDfuImpl;
import p036no.nordicsemi.android.dfu.BaseDfuImpl;
import p036no.nordicsemi.android.dfu.internal.ArchiveInputStream;
...
import p036no.nordicsemi.android.dfu.internal.exception.RemoteDfuException;
import p036no.nordicsemi.android.dfu.internal.exception.RemoteDfuExtendedErrorException;
import p036no.nordicsemi.android.dfu.internal.exception.UnknownResponseException;
import p036no.nordicsemi.android.dfu.internal.exception.UploadAbortedException;
import p036no.nordicsemi.android.error.SecureDfuError;
...
class SecureDfuImpl extends BaseCustomDfuImpl {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x0178, code lost:
        ...
        r10.mService.terminateConnection(r1, 4104);
     */
    ...
    public void performDfu(android.content.Intent r11) throws p036no.nordicsemi.android.dfu.internal.exception.DfuException, p036no.nordicsemi.android.dfu.internal.exception.DeviceDisconnectedException, p036no.nordicsemi.android.dfu.internal.exception.UploadAbortedException {
        /*
            r10 = this;
        ...
        L_0x007d:
            ...
            no.nordicsemi.android.dfu.internal.ArchiveInputStream r0 = (p036no.nordicsemi.android.dfu.internal.ArchiveInputStream) r0     // Catch:{ UploadAbortedException -> 0x0190, UnknownResponseException -> 0x0177, RemoteDfuException -> 0x00dd }
        ...
        L_0x00dd:
            ...
            java.lang.String r3 = ": "
            r2.append(r3)
            java.lang.String r3 = p036no.nordicsemi.android.error.SecureDfuError.parse(r0)
            r2.append(r3)
            ...
            java.lang.String r7 = p036no.nordicsemi.android.error.SecureDfuError.parse(r0)
            r5[r6] = r7
            java.lang.String r6 = "Remote DFU error: %s"
            java.lang.String r3 = java.lang.String.format(r3, r6, r5)
            r2.sendLogBroadcast(r4, r3)
            boolean r2 = r11 instanceof p036no.nordicsemi.android.dfu.internal.exception.RemoteDfuExtendedErrorException
            if (r2 == 0) goto L_0x016f
            no.nordicsemi.android.dfu.internal.exception.RemoteDfuExtendedErrorException r11 = (p036no.nordicsemi.android.dfu.internal.exception.RemoteDfuExtendedErrorException) r11
            ...
            r2.append(r3)
            java.lang.String r3 = p036no.nordicsemi.android.error.SecureDfuError.parseExtendedError(r0)
            r2.append(r3)
            java.lang.String r2 = r2.toString()
            r10.loge(r2)
            no.nordicsemi.android.dfu.DfuBaseService r2 = r10.mService
            ...
            r3.append(r5)
            java.lang.String r5 = p036no.nordicsemi.android.error.SecureDfuError.parseExtendedError(r0)
            r3.append(r5)
        ...
        L_0x0190:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: p036no.nordicsemi.android.dfu.SecureDfuImpl.performDfu(android.content.Intent):void");
    }

    /* JADX WARNING: Removed duplicated region for block: B:38:0x011c  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void sendInitPacket(android.bluetooth.BluetoothGatt r18, boolean r19) throws p036no.nordicsemi.android.dfu.internal.exception.RemoteDfuException, p036no.nordicsemi.android.dfu.internal.exception.DeviceDisconnectedException, p036no.nordicsemi.android.dfu.internal.exception.DfuException, p036no.nordicsemi.android.dfu.internal.exception.UploadAbortedException, p036no.nordicsemi.android.dfu.internal.exception.UnknownResponseException {
        /*
            r17 = this;
            r1 = r17
            r2 = r18
        ...
        L_0x025b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p036no.nordicsemi.android.dfu.SecureDfuImpl.sendInitPacket(android.bluetooth.BluetoothGatt, boolean):void");
    }

    /* JADX WARNING: Code restructure failed: missing block: B:60:0x032a, code lost:
        if (r1.mPacketsBeforeNotification > 1) goto L_0x032e;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void sendFirmware(android.bluetooth.BluetoothGatt r27) throws p036no.nordicsemi.android.dfu.internal.exception.RemoteDfuException, p036no.nordicsemi.android.dfu.internal.exception.DeviceDisconnectedException, p036no.nordicsemi.android.dfu.internal.exception.DfuException, p036no.nordicsemi.android.dfu.internal.exception.UploadAbortedException, p036no.nordicsemi.android.dfu.internal.exception.UnknownResponseException {
        /*
            r26 = this;
            r1 = r26
            r2 = r27
        ...
        L_0x0030:
            ...
            java.lang.String r14 = "Executing data object (Op Code = 4)"
            if (r10 <= 0) goto L_0x01d5
            int r10 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            int r15 = r9.maxSize     // Catch:{ IOException -> 0x01c9 }
            int r10 = r10 / r15
            int r15 = r9.maxSize     // Catch:{ IOException -> 0x01c9 }
            int r15 = r15 * r10
            int r11 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            int r11 = r11 - r15
            if (r11 != 0) goto L_0x00b6
            int r11 = r9.maxSize     // Catch:{ IOException -> 0x01c9 }
            int r15 = r15 - r11
            int r11 = r9.maxSize     // Catch:{ IOException -> 0x01c9 }
        L_0x00b6:
            if (r15 <= 0) goto L_0x00c9
            java.io.InputStream r12 = r1.mFirmwareStream     // Catch:{ IOException -> 0x01c9 }
            r21 = r10
            byte[] r10 = new byte[r15]     // Catch:{ IOException -> 0x01c9 }
            r12.read(r10)     // Catch:{ IOException -> 0x01c9 }
            java.io.InputStream r10 = r1.mFirmwareStream     // Catch:{ IOException -> 0x01c9 }
            int r12 = r9.maxSize     // Catch:{ IOException -> 0x01c9 }
            r10.mark(r12)     // Catch:{ IOException -> 0x01c9 }
            goto L_0x00cb
        L_0x00c9:
            r21 = r10
        L_0x00cb:
            java.io.InputStream r10 = r1.mFirmwareStream     // Catch:{ IOException -> 0x01c9 }
            byte[] r12 = new byte[r11]     // Catch:{ IOException -> 0x01c9 }
            r10.read(r12)     // Catch:{ IOException -> 0x01c9 }
            java.io.InputStream r10 = r1.mFirmwareStream     // Catch:{ IOException -> 0x01c9 }
            no.nordicsemi.android.dfu.internal.ArchiveInputStream r10 = (p036no.nordicsemi.android.dfu.internal.ArchiveInputStream) r10     // Catch:{ IOException -> 0x01c9 }
            long r22 = r10.getCrc32()     // Catch:{ IOException -> 0x01c9 }
            r10 = r7
            r12 = r8
            r19 = 4294967295(0xffffffff, double:2.1219957905E-314)
            long r7 = r22 & r19
            int r8 = (int) r7     // Catch:{ IOException -> 0x01c9 }
            int r7 = r9.CRC32     // Catch:{ IOException -> 0x01c9 }
            ...
            int r3 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            r0.append(r3)     // Catch:{ IOException -> 0x01c9 }
            r0.append(r4)     // Catch:{ IOException -> 0x01c9 }
            java.lang.String r0 = r0.toString()     // Catch:{ IOException -> 0x01c9 }
            r1.logi(r0)     // Catch:{ IOException -> 0x01c9 }
            no.nordicsemi.android.dfu.DfuBaseService r0 = r1.mService     // Catch:{ IOException -> 0x01c9 }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x01c9 }
            r3.<init>()     // Catch:{ IOException -> 0x01c9 }
            int r5 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            r3.append(r5)     // Catch:{ IOException -> 0x01c9 }
            r3.append(r4)     // Catch:{ IOException -> 0x01c9 }
            java.lang.String r3 = r3.toString()     // Catch:{ IOException -> 0x01c9 }
            r4 = 10
            r0.sendLogBroadcast(r4, r3)     // Catch:{ IOException -> 0x01c9 }
            no.nordicsemi.android.dfu.DfuProgressInfo r0 = r1.mProgressInfo     // Catch:{ IOException -> 0x01c9 }
            int r3 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            r0.setBytesSent(r3)     // Catch:{ IOException -> 0x01c9 }
            no.nordicsemi.android.dfu.DfuProgressInfo r0 = r1.mProgressInfo     // Catch:{ IOException -> 0x01c9 }
            int r3 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            r0.setBytesReceived(r3)     // Catch:{ IOException -> 0x01c9 }
            int r0 = r9.maxSize     // Catch:{ IOException -> 0x01c9 }
            if (r11 != r0) goto L_0x014f
            int r0 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            int r3 = r1.mImageSizeInBytes     // Catch:{ IOException -> 0x01c9 }
            if (r0 >= r3) goto L_0x014f
            r1.logi(r14)     // Catch:{ IOException -> 0x01c9 }
        ...
        L_0x013b:
            r0 = move-exception
            int r3 = r0.getErrorNumber()     // Catch:{ IOException -> 0x01c9 }
            r4 = 8
        ...
        L_0x014f:
            ...
            goto L_0x01e0
        L_0x0152:
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x01c9 }
            r4.<init>()     // Catch:{ IOException -> 0x01c9 }
            int r7 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            r4.append(r7)     // Catch:{ IOException -> 0x01c9 }
            r4.append(r5)     // Catch:{ IOException -> 0x01c9 }
            java.lang.String r4 = r4.toString()     // Catch:{ IOException -> 0x01c9 }
            r1.logi(r4)     // Catch:{ IOException -> 0x01c9 }
            no.nordicsemi.android.dfu.DfuBaseService r4 = r1.mService     // Catch:{ IOException -> 0x01c9 }
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x01c9 }
            r7.<init>()     // Catch:{ IOException -> 0x01c9 }
            int r8 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            r7.append(r8)     // Catch:{ IOException -> 0x01c9 }
            r7.append(r5)     // Catch:{ IOException -> 0x01c9 }
            java.lang.String r5 = r7.toString()     // Catch:{ IOException -> 0x01c9 }
            r7 = 15
            r4.sendLogBroadcast(r7, r5)     // Catch:{ IOException -> 0x01c9 }
            no.nordicsemi.android.dfu.DfuProgressInfo r4 = r1.mProgressInfo     // Catch:{ IOException -> 0x01c9 }
            r4.setBytesSent(r15)     // Catch:{ IOException -> 0x01c9 }
            no.nordicsemi.android.dfu.DfuProgressInfo r4 = r1.mProgressInfo     // Catch:{ IOException -> 0x01c9 }
            r4.setBytesReceived(r15)     // Catch:{ IOException -> 0x01c9 }
            int r4 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            int r4 = r4 - r11
            r9.offset = r4     // Catch:{ IOException -> 0x01c9 }
            r4 = 0
            r9.CRC32 = r4     // Catch:{ IOException -> 0x01c9 }
            java.io.InputStream r4 = r1.mFirmwareStream     // Catch:{ IOException -> 0x01c9 }
            r4.reset()     // Catch:{ IOException -> 0x01c9 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x01c9 }
            r4.<init>()     // Catch:{ IOException -> 0x01c9 }
            r4.append(r3)     // Catch:{ IOException -> 0x01c9 }
            int r5 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            r4.append(r5)     // Catch:{ IOException -> 0x01c9 }
            r4.append(r0)     // Catch:{ IOException -> 0x01c9 }
            java.lang.String r4 = r4.toString()     // Catch:{ IOException -> 0x01c9 }
            r1.logi(r4)     // Catch:{ IOException -> 0x01c9 }
            no.nordicsemi.android.dfu.DfuBaseService r4 = r1.mService     // Catch:{ IOException -> 0x01c9 }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x01c9 }
            r5.<init>()     // Catch:{ IOException -> 0x01c9 }
            r5.append(r3)     // Catch:{ IOException -> 0x01c9 }
            int r3 = r9.offset     // Catch:{ IOException -> 0x01c9 }
            r5.append(r3)     // Catch:{ IOException -> 0x01c9 }
            r5.append(r0)     // Catch:{ IOException -> 0x01c9 }
            java.lang.String r0 = r5.toString()     // Catch:{ IOException -> 0x01c9 }
            r3 = 10
            r4.sendLogBroadcast(r3, r0)     // Catch:{ IOException -> 0x01c9 }
        L_0x01c7:
            r0 = 0
            goto L_0x01e0
        L_0x01c9:
        ...
        L_0x01eb:
            ...
            java.lang.StringBuilder r11 = new java.lang.StringBuilder
            r11.<init>()
            java.lang.String r15 = "Creating Data object (Op Code = 1, Type = 2, Size = "
            r11.append(r15)
            r11.append(r8)
        ...
        L_0x0273:
            ...
            r0 = 0
        L_0x027f:
            r1.logi(r7)     // Catch:{ DeviceDisconnectedException -> 0x0436 }
            android.bluetooth.BluetoothGattCharacteristic r7 = r1.mPacketCharacteristic     // Catch:{ DeviceDisconnectedException -> 0x0436 }
            r1.uploadFirmwareImage(r7)     // Catch:{ DeviceDisconnectedException -> 0x0436 }
            java.lang.String r7 = "Sending Calculate Checksum command (Op Code = 3)"
            r1.logi(r7)
            ...
            java.io.InputStream r8 = r1.mFirmwareStream     // Catch:{ IOException -> 0x0360, all -> 0x033d }
            r8.reset()     // Catch:{ IOException -> 0x0360, all -> 0x033d }
            java.io.InputStream r8 = r1.mFirmwareStream     // Catch:{ IOException -> 0x0360, all -> 0x033d }
            int r10 = r9.maxSize     // Catch:{ IOException -> 0x0360, all -> 0x033d }
            int r10 = r10 - r0
            byte[] r10 = new byte[r10]     // Catch:{ IOException -> 0x0360, all -> 0x033d }
            r8.read(r10)     // Catch:{ IOException -> 0x0360, all -> 0x033d }
            no.nordicsemi.android.dfu.DfuProgressInfo r8 = r1.mProgressInfo     // Catch:{ IOException -> 0x0360, all -> 0x033d }
            int r10 = r7.offset     // Catch:{ IOException -> 0x0360, all -> 0x033d }
            r8.setBytesSent(r10)     // Catch:{ IOException -> 0x0360, all -> 0x033d }
            int r8 = r1.mPacketsBeforeNotification
            if (r8 == 0) goto L_0x032d
            int r8 = r1.mPacketsBeforeNotification
            r10 = 1
            if (r8 <= r10) goto L_0x036c
            goto L_0x032e
        L_0x032d:
            r10 = 1
        L_0x032e:
        ...
        L_0x036c:
            ...
            no.nordicsemi.android.dfu.internal.ArchiveInputStream r8 = (p036no.nordicsemi.android.dfu.internal.ArchiveInputStream) r8
        ...
        L_0x03aa:
            ...
            java.lang.String r0 = java.lang.String.format(r0, r7, r15)
            r7 = 3
            if (r5 >= r7) goto L_0x0424
            int r5 = r5 + 1
            java.lang.StringBuilder r8 = new java.lang.StringBuilder
            r8.<init>()
            r8.append(r0)
            ...
            r17 = 1
            r11[r17] = r15
            java.lang.String r15 = " Retrying...(%d/%d)"
            java.lang.String r0 = java.lang.String.format(r0, r15, r11)
            r8.append(r0)
            ...
            java.io.InputStream r0 = r1.mFirmwareStream     // Catch:{ IOException -> 0x0416 }
            r0.reset()     // Catch:{ IOException -> 0x0416 }
            no.nordicsemi.android.dfu.DfuProgressInfo r0 = r1.mProgressInfo     // Catch:{ IOException -> 0x0416 }
            java.io.InputStream r8 = r1.mFirmwareStream     // Catch:{ IOException -> 0x0416 }
            no.nordicsemi.android.dfu.internal.ArchiveInputStream r8 = (p036no.nordicsemi.android.dfu.internal.ArchiveInputStream) r8     // Catch:{ IOException -> 0x0416 }
            int r8 = r8.getBytesRead()     // Catch:{ IOException -> 0x0416 }
            r0.setBytesSent(r8)     // Catch:{ IOException -> 0x0416 }
        L_0x0410:
            r0 = r22
            r10 = r23
            goto L_0x01eb
        ...
        L_0x044b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p036no.nordicsemi.android.dfu.SecureDfuImpl.sendFirmware(android.bluetooth.BluetoothGatt):void");
    }
    ...
    private int unsignedBytesToInt(byte[] bArr, int i) {
        return (bArr[i] & UByte.MAX_VALUE) + ((bArr[i + 1] & UByte.MAX_VALUE) << 8) + ((bArr[i + 2] & UByte.MAX_VALUE) << BidiOrder.f527S) + ((bArr[i + 3] & UByte.MAX_VALUE) << 24);
    }

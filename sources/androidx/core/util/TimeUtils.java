...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        boolean z = i7 != 0;
        int i13 = i12;
        int printField = printField(cArr, i2, Barcode128.CODE_AC_TO_B, i12, false, 0);
        int printField2 = printField(cArr, i3, Barcode128.START_B, printField, printField != i13, z ? 2 : 0);

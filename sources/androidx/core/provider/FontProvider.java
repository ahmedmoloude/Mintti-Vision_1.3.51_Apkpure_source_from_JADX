...
class FontProvider {
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontProvider.C02941.compare(byte[], byte[]):int");
        }
    };
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        Uri build = new Uri.Builder().scheme(Annotation.CONTENT).authority(str2).build();
        Uri build2 = new Uri.Builder().scheme(Annotation.CONTENT).authority(str2).appendPath(Annotation.FILE).build();
        Cursor cursor = null;
        try {

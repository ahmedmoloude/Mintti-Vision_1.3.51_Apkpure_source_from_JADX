...
public final class WindowInsetsAnimationCompat {
    ...
    public static final class BoundsCompat {
        ...
        public BoundsCompat inset(Insets insets) {
            return new BoundsCompat(WindowInsetsCompat.insetInsets(this.mLowerBound, insets.left, insets.f2161top, insets.right, insets.bottom), WindowInsetsCompat.insetInsets(this.mUpperBound, insets.left, insets.f2161top, insets.right, insets.bottom));
        }
    ...
    private static class Impl21 extends Impl {
        ...
        static void setCallback(View view, Callback callback) {
            Object tag = view.getTag(C0250R.C0253id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0250R.C0253id.tag_window_insets_animation_callback, (Object) null);
                if (tag == null) {
            ...
            view.setTag(C0250R.C0253id.tag_window_insets_animation_callback, createProxyListener);
            if (tag == null) {
        ...
        static BoundsCompat computeAnimationBounds(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, int i) {
            ...
            return new BoundsCompat(Insets.m38of(Math.min(insets.left, insets2.left), Math.min(insets.f2161top, insets2.f2161top), Math.min(insets.right, insets2.right), Math.min(insets.bottom, insets2.bottom)), Insets.m38of(Math.max(insets.left, insets2.left), Math.max(insets.f2161top, insets2.f2161top), Math.max(insets.right, insets2.right), Math.max(insets.bottom, insets2.bottom)));
        }
        ...
        static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f, int i) {
            ...
            for (int i2 = 1; i2 <= 256; i2 <<= 1) {
                if ((i & i2) == 0) {
                    ...
                    float f2 = 1.0f - f;
                    builder.setInsets(i2, WindowInsetsCompat.insetInsets(insets, (int) (((double) (((float) (insets.left - insets2.left)) * f2)) + 0.5d), (int) (((double) (((float) (insets.f2161top - insets2.f2161top)) * f2)) + 0.5d), (int) (((double) (((float) (insets.right - insets2.right)) * f2)) + 0.5d), (int) (((double) (((float) (insets.bottom - insets2.bottom)) * f2)) + 0.5d)));
                }
            }
        ...
        static WindowInsets forwardToViewIfNeeded(View view, WindowInsets windowInsets) {
            if (view.getTag(C0250R.C0253id.tag_on_apply_window_listener) != null) {
                return windowInsets;
            }
        ...
        static Callback getCallback(View view) {
            Object tag = view.getTag(C0250R.C0253id.tag_window_insets_animation_callback);

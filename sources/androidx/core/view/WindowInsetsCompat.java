...
public class WindowInsetsCompat {
    ...
    public int getSystemWindowInsetTop() {
        return this.mImpl.getSystemWindowInsets().f2161top;
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m38of(i, i2, i3, i4)).build();
    }

    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m39of(rect)).build();
    }

    @Deprecated
    public int getStableInsetTop() {
        return this.mImpl.getStableInsets().f2161top;
    }
    ...
    public WindowInsetsCompat inset(Insets insets) {
        return inset(insets.left, insets.f2161top, insets.right, insets.bottom);
    }
    ...
    private static class Impl20 extends Impl {
                ...
                if (i != 2) {
                    if (i == 8) {
                        ...
                        if (systemWindowInsets.bottom > rootStableInsets.bottom) {
                            return Insets.m38of(0, 0, 0, systemWindowInsets.bottom);
                        }
                        ...
                        return Insets.m38of(0, 0, 0, this.mRootViewVisibleInsets.bottom);
                    } else if (i == 16) {
                        ...
                        if (displayCutoutCompat != null) {
                            return Insets.m38of(displayCutoutCompat.getSafeInsetLeft(), displayCutoutCompat.getSafeInsetTop(), displayCutoutCompat.getSafeInsetRight(), displayCutoutCompat.getSafeInsetBottom());
                        }
                        return Insets.NONE;
                    }
                } else if (z) {
                    ...
                    return Insets.m38of(Math.max(rootStableInsets2.left, stableInsets.left), 0, Math.max(rootStableInsets2.right, stableInsets.right), Math.max(rootStableInsets2.bottom, stableInsets.bottom));
                } else {
                    ...
                    return Insets.m38of(systemWindowInsets2.left, 0, systemWindowInsets2.right, i2);
                }
            } else if (z) {
                return Insets.m38of(0, Math.max(getRootStableInsets().f2161top, getSystemWindowInsets().f2161top), 0, 0);
            } else {
                return Insets.m38of(0, getSystemWindowInsets().f2161top, 0, 0);
            }
        }
        ...
        public final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m38of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
    ...
    private static class Impl21 extends Impl20 {
        ...
        public final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m38of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        int max2 = Math.max(0, insets.f2161top - i2);
        int max3 = Math.max(0, insets.right - i3);
        int max4 = Math.max(0, insets.bottom - i4);
        if (max == i && max2 == i2 && max3 == i3 && max4 == i4) {
            return insets;
        }
        return Insets.m38of(max, max2, max3, max4);
    }
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        public void setSystemWindowInsets(Insets insets) {
            ...
            if (windowInsets != null) {
                this.mPlatformInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f2161top, insets.right, insets.bottom);
            }
        }
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (!(rect == null || rect2 == null)) {
                            WindowInsetsCompat build = new Builder().setStableInsets(Insets.m39of(rect)).setSystemWindowInsets(Insets.m39of(rect2)).build();

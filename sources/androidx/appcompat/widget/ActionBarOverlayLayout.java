...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0071R.attr.actionBarSize, 16842841};
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!this.mOverlayMode && !z) {
            ...
            this.mInnerInsets = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.m38of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + i3, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom() + 0)).build();
        } else {
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0071R.C0075id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0071R.C0075id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0071R.C0075id.action_bar));
        }
    }

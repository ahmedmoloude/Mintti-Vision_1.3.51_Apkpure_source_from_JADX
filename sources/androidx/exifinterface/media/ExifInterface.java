...
public class ExifInterface {
    ...
    public void setAttribute(java.lang.String r18, java.lang.String r19) {
        ...
        L_0x005e:
            ...
            goto L_0x00be
        L_0x0097:
            double r9 = java.lang.Double.parseDouble(r19)     // Catch:{ NumberFormatException -> 0x00a5 }
            androidx.exifinterface.media.ExifInterface$Rational r6 = new androidx.exifinterface.media.ExifInterface$Rational     // Catch:{ NumberFormatException -> 0x00a5 }
            r6.<init>(r9)     // Catch:{ NumberFormatException -> 0x00a5 }
            java.lang.String r2 = r6.toString()     // Catch:{ NumberFormatException -> 0x00a5 }
            goto L_0x00be
        L_0x00a5:
            java.lang.StringBuilder r3 = new java.lang.StringBuilder
            r3.<init>()
    ...
    /* JADX WARNING: Removed duplicated region for block: B:44:0x00b5 A[Catch:{ Exception -> 0x00e8, all -> 0x00e4 }] */
    /* JADX WARNING: Removed duplicated region for block: B:45:0x00bd A[Catch:{ Exception -> 0x00e8, all -> 0x00e4 }] */
    ...
    public void saveAttributes() throws java.io.IOException {
        ...
        L_0x001c:
            ...
            r1 = 0
            java.lang.String r2 = r8.mFilename     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            r3 = 0
            r5 = 21
            if (r2 == 0) goto L_0x0070
            java.io.File r2 = new java.io.File     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            r6.<init>()     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.lang.String r7 = r8.mFilename     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            r6.append(r7)     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.lang.String r7 = ".tmp"
            r6.append(r7)     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.lang.String r6 = r6.toString()     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            r2.<init>(r6)     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.io.File r6 = new java.io.File     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.lang.String r7 = r8.mFilename     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            r6.<init>(r7)     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            boolean r6 = r6.renameTo(r2)     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            if (r6 == 0) goto L_0x0055
            r6 = r1
            goto L_0x00a5
        L_0x0055:
            java.io.IOException r3 = new java.io.IOException     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            r4.<init>()     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.lang.String r5 = "Couldn't rename to "
            r4.append(r5)     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.lang.String r2 = r2.getAbsolutePath()     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            r4.append(r2)     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.lang.String r2 = r4.toString()     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            r3.<init>(r2)     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            throw r3     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
        L_0x0070:
            int r2 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            if (r2 < r5) goto L_0x00a3
            java.io.FileDescriptor r2 = r8.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            if (r2 == 0) goto L_0x00a3
            java.lang.String r2 = "temp"
            java.lang.String r6 = "jpg"
            java.io.File r2 = java.io.File.createTempFile(r2, r6)     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.io.FileDescriptor r6 = r8.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            android.system.Os.lseek(r6, r3, r7)     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.io.FileInputStream r6 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.io.FileDescriptor r7 = r8.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            r6.<init>(r7)     // Catch:{ Exception -> 0x0103, all -> 0x0100 }
            java.io.FileOutputStream r7 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x009f, all -> 0x009a }
            r7.<init>(r2)     // Catch:{ Exception -> 0x009f, all -> 0x009a }
            copy(r6, r7)     // Catch:{ Exception -> 0x00a0, all -> 0x0098 }
            goto L_0x00a6
        L_0x0098:
            r0 = move-exception
            goto L_0x009c
        ...
        L_0x00a6:
            closeQuietly(r6)
            closeQuietly(r7)
            java.io.FileInputStream r6 = new java.io.FileInputStream     // Catch:{ Exception -> 0x00ee, all -> 0x00eb }
            r6.<init>(r2)     // Catch:{ Exception -> 0x00ee, all -> 0x00eb }
            java.lang.String r7 = r8.mFilename     // Catch:{ Exception -> 0x00e8, all -> 0x00e4 }
            if (r7 == 0) goto L_0x00bd
            java.io.FileOutputStream r3 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00e8, all -> 0x00e4 }
            java.lang.String r4 = r8.mFilename     // Catch:{ Exception -> 0x00e8, all -> 0x00e4 }
            r3.<init>(r4)     // Catch:{ Exception -> 0x00e8, all -> 0x00e4 }
            goto L_0x00d3
        L_0x00bd:
            int r7 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x00e8, all -> 0x00e4 }
            if (r7 < r5) goto L_0x00d2
            java.io.FileDescriptor r5 = r8.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00e8, all -> 0x00e4 }
            if (r5 == 0) goto L_0x00d2
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x00e8, all -> 0x00e4 }
            android.system.Os.lseek(r5, r3, r7)     // Catch:{ Exception -> 0x00e8, all -> 0x00e4 }
            java.io.FileOutputStream r3 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00e8, all -> 0x00e4 }
            java.io.FileDescriptor r4 = r8.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00e8, all -> 0x00e4 }
            r3.<init>(r4)     // Catch:{ Exception -> 0x00e8, all -> 0x00e4 }
            goto L_0x00d3
        L_0x00d2:
            r3 = r1
        L_0x00d3:
            r8.saveJpegAttributes(r6, r3)     // Catch:{ Exception -> 0x00e9, all -> 0x00e2 }
            closeQuietly(r6)
            closeQuietly(r3)
            r2.delete()
            r8.mThumbnailBytes = r1
        ...
        L_0x00ee:
            r3 = r1
        L_0x00ef:
            java.io.IOException r4 = new java.io.IOException     // Catch:{ all -> 0x00f5 }
        ...
        L_0x0103:
            r7 = r1
        L_0x0104:
            java.io.IOException r2 = new java.io.IOException     // Catch:{ all -> 0x010a }
            r2.<init>(r0)     // Catch:{ all -> 0x010a }
    ...
    public Bitmap getThumbnailBitmap() {
        ...
        if (i == 1) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                int i3 = i2 * 3;
                iArr[i2] = (bArr[i3] << BidiOrder.f527S) + 0 + (bArr[i3 + 1] << 8) + bArr[i3 + 2];
            }
    ...
    private boolean isHeifFormat(byte[] r15) throws java.io.IOException {
        ...
        L_0x0039:
            r5 = r7
        L_0x003a:
            int r11 = r15.length     // Catch:{ Exception -> 0x008d, all -> 0x008a }
            long r11 = (long) r11     // Catch:{ Exception -> 0x008d, all -> 0x008a }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:71:0x00f2 A[SYNTHETIC] */

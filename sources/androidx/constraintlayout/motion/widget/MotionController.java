...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f150x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f151y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f150x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f151y;
    }
    ...
    public KeyPositionBase getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        rectF.left = this.mStartMotionPath.f150x;
        rectF.top = this.mStartMotionPath.f151y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f150x;
        rectF2.top = this.mEndMotionPath.f151y;
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f150x - this.mStartMotionPath.f150x;
        float f4 = this.mEndMotionPath.f151y - this.mStartMotionPath.f151y;
        float f5 = this.mStartMotionPath.f150x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f151y + (this.mStartMotionPath.height / 2.0f);
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f150x + " y: " + this.mStartMotionPath.f151y + " end: x: " + this.mEndMotionPath.f150x + " y: " + this.mEndMotionPath.f151y;
    }
    ...
    public void setStartState(ViewState viewState, View view, int i, int i2, int i3) {
        ...
        if (i == 1) {
            ...
            rect.left = ((viewState.f2158top + viewState.bottom) - viewState.width()) / 2;
            rect.top = i2 - ((i4 + viewState.height()) / 2);
            rect.right = rect.left + viewState.width();
            rect.bottom = rect.top + viewState.height();
        } else if (i == 2) {
            int i5 = viewState.left + viewState.right;
            rect.left = i3 - (((viewState.f2158top + viewState.bottom) + viewState.width()) / 2);
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f150x - this.mStartMotionPath.f150x;
        float f6 = this.mEndMotionPath.f151y - this.mStartMotionPath.f151y;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            float f7 = this.mEndMotionPath.f150x - this.mStartMotionPath.f150x;
            float f8 = this.mEndMotionPath.f151y - this.mStartMotionPath.f151y;

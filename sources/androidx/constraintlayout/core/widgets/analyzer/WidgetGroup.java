...
public class WidgetGroup {
    ...
    public String toString() {
        String str = getOrientationString() + " [" + this.f143id + "] <";
    ...
    public void moveTo(int i, WidgetGroup widgetGroup) {
        ...
        this.moveTo = widgetGroup.f143id;
    }
    ...
    public void cleanup(ArrayList<WidgetGroup> arrayList) {
        ...
        if (this.moveTo != -1 && size > 0) {
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (this.moveTo == widgetGroup.f143id) {
    ...
    class MeasureResult {
        ...
        public MeasureResult(ConstraintWidget constraintWidget, LinearSystem linearSystem, int i) {
            ...
            this.f2157top = linearSystem.getObjectVariableValue(constraintWidget.mTop);
        ...
        public void apply() {
            ...
            if (constraintWidget != null) {
                constraintWidget.setFinalFrame(this.left, this.f2157top, this.right, this.bottom, this.baseline, this.orientation);
            }
        }
    }
}

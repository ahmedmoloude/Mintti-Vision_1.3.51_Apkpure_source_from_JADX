...
public class State {
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference2 == null) {
            int i = C02021.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C02021 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.state.State.C02021.<clinit>():void");
        }
    }

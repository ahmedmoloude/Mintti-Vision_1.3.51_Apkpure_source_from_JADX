...
public class WidgetFrame {
    ...
    public int height() {
        return Math.max(0, this.bottom - this.f2156top);
    }
    ...
    public WidgetFrame(WidgetFrame widgetFrame) {
        ...
        this.f2156top = widgetFrame.f2156top;
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        int i14 = widgetFrame5.f2156top;
        int i15 = widgetFrame6.left;
        int i16 = widgetFrame6.f2156top;
        ...
        if (widgetFrame4.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (findPreviousPosition != null) {
                i5 = (int) (findPreviousPosition.f131x * ((float) i));
                i7 = i2;
                i14 = (int) (findPreviousPosition.f132y * ((float) i7));
            ...
            if (findNextPosition != null) {
                i15 = (int) (findNextPosition.f131x * ((float) i8));
                i16 = (int) (findNextPosition.f132y * ((float) i7));
    ...
    public WidgetFrame update() {
        ...
        if (constraintWidget != null) {
            ...
            this.f2156top = this.widget.getTop();
    ...
    public boolean setValue(String str, CLElement cLElement) throws CLParsingException {
        ...
        switch (c) {
            ...
            case 12:
                ...
                break;
            case 13:
                this.f2156top = cLElement.getInt();
                break;
            case 14:
    ...
    public StringBuilder serialize(StringBuilder sb, boolean z) {
        sb.append("{\n");
        add(sb, HtmlTags.ALIGN_LEFT, this.left);
        add(sb, HtmlTags.ALIGN_TOP, this.f2156top);
        add(sb, HtmlTags.ALIGN_RIGHT, this.right);
        add(sb, HtmlTags.ALIGN_BOTTOM, this.bottom);

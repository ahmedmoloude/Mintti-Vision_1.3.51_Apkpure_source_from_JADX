...
public class ArrayRow implements LinearSystem.Row {
    ...
    public ArrayRow addError(LinearSystem linearSystem, int i) {
        ...
        this.variables.put(linearSystem.createErrorVariable(i, HtmlTags.f478EM), -1.0f);
        return this;
    }
    ...
    private SolverVariable pickPivotInVariables(boolean[] zArr, SolverVariable solverVariable) {
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (variableValue < 0.0f) {
                SolverVariable variable2 = this.variables.getVariable(i);
                if ((zArr == null || !zArr[variable2.f109id]) && variable2 != solverVariable && ((variable2.mType == SolverVariable.Type.SLACK || variable2.mType == SolverVariable.Type.ERROR) && variableValue < f)) {
                    f = variableValue;
                    solverVariable2 = variable2;
                }
            }

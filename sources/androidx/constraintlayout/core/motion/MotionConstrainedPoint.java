...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    public void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f112x, motionConstrainedPoint.f112x);
        zArr[2] = zArr[2] | diff(this.f113y, motionConstrainedPoint.f113y);
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f112x, this.f113y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int i = 0;
    ...
    public void setState(Rect rect, MotionWidget motionWidget, int i, float f) {
        setBounds((float) rect.left, (float) rect.f2154top, (float) rect.width(), (float) rect.height());
        applyParameters(motionWidget);

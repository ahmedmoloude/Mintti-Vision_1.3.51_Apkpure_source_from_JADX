...
public class Motion implements TypedValues {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f114x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f115y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f114x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f115y;
    }
    ...
    public MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.left = this.mStartMotionPath.f114x;
        floatRect.f2153top = this.mStartMotionPath.f115y;
        floatRect.right = floatRect.left + this.mStartMotionPath.width;
        floatRect.bottom = floatRect.f2153top + this.mStartMotionPath.height;
        FloatRect floatRect2 = new FloatRect();
        floatRect2.left = this.mEndMotionPath.f114x;
        floatRect2.f2153top = this.mEndMotionPath.f115y;
        floatRect2.right = floatRect2.left + this.mEndMotionPath.width;
        floatRect2.bottom = floatRect2.f2153top + this.mEndMotionPath.height;
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f114x - this.mStartMotionPath.f114x;
        float f4 = this.mEndMotionPath.f115y - this.mStartMotionPath.f115y;
        float f5 = this.mStartMotionPath.f114x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f115y + (this.mStartMotionPath.height / 2.0f);
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f114x + " y: " + this.mStartMotionPath.f115y + " end: x: " + this.mEndMotionPath.f114x + " y: " + this.mEndMotionPath.f115y;
    }
    ...
    public void setStartState(ViewState viewState, MotionWidget motionWidget, int i, int i2, int i3) {
        ...
        if (i == 1) {
            ...
            rect.left = ((viewState.f2155top + viewState.bottom) - viewState.width()) / 2;
            rect.f2154top = i2 - ((i4 + viewState.height()) / 2);
            rect.right = rect.left + viewState.width();
            rect.bottom = rect.f2154top + viewState.height();
        } else if (i == 2) {
            int i5 = viewState.left + viewState.right;
            rect.left = i3 - (((viewState.f2155top + viewState.bottom) + viewState.width()) / 2);
            rect.f2154top = (i5 - viewState.height()) / 2;
            rect.right = rect.left + viewState.width();
            rect.bottom = rect.f2154top + viewState.height();
        }
        this.mStartMotionPath.setBounds((float) rect.left, (float) rect.f2154top, (float) rect.width(), (float) rect.height());
    ...
    public void rotate(Rect rect, Rect rect2, int i, int i2, int i3) {
        if (i == 1) {
            ...
            rect2.left = ((rect.f2154top + rect.bottom) - rect.width()) / 2;
            rect2.f2154top = i3 - ((i4 + rect.height()) / 2);
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f2154top + rect.height();
        } else if (i == 2) {
            int i5 = rect.left + rect.right;
            rect2.left = i2 - (((rect.f2154top + rect.bottom) + rect.width()) / 2);
            rect2.f2154top = (i5 - rect.height()) / 2;
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f2154top + rect.height();
        } else if (i == 3) {
            int i6 = rect.left + rect.right;
            int i7 = rect.f2154top;
            int i8 = rect.bottom;
            rect2.left = ((rect.height() / 2) + rect.f2154top) - (i6 / 2);
            rect2.f2154top = i3 - ((i6 + rect.height()) / 2);
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f2154top + rect.height();
        } else if (i == 4) {
            int i9 = rect.left + rect.right;
            rect2.left = i2 - (((rect.bottom + rect.f2154top) + rect.width()) / 2);
            rect2.f2154top = (i9 - rect.height()) / 2;
            rect2.right = rect2.left + rect.width();
            rect2.bottom = rect2.f2154top + rect.height();
        }
    }
    ...
    private static DifferentialInterpolator getInterpolator(int i, String str, int i2) {
        ...
        return new DifferentialInterpolator() {
            ...
            public float getVelocity() {
                return (float) interpolator.getDiff((double) this.f111mX);
            }
        };
    }
        ...
        if (curveFitArr != null) {
            ...
            if (this.mTransformPivotTarget != -1) {
                ...
                if (motionWidget3 != null) {
                    float top2 = ((float) (motionWidget3.getTop() + this.mTransformPivotView.getBottom())) / 2.0f;
                    ...
                    if (motionWidget.getRight() - motionWidget.getLeft() > 0 && motionWidget.getBottom() - motionWidget.getTop() > 0) {
                        ...
                        motionWidget2.setPivotY(top2 - ((float) motionWidget.getTop()));
                    }
                }
            }
            int i2 = 1;
            ...
            float f5 = this.mStartMotionPath.f114x + ((this.mEndMotionPath.f114x - this.mStartMotionPath.f114x) * f4) + 0.5f;
            float f6 = this.mStartMotionPath.f115y + ((this.mEndMotionPath.f115y - this.mStartMotionPath.f115y) * f4) + 0.5f;
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f114x - this.mStartMotionPath.f114x;
        float f6 = this.mEndMotionPath.f115y - this.mStartMotionPath.f115y;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            float f7 = this.mEndMotionPath.f114x - this.mStartMotionPath.f114x;
            float f8 = this.mEndMotionPath.f115y - this.mStartMotionPath.f115y;

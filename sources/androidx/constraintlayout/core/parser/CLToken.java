...
public class CLToken extends CLElement {
    int index = 0;
    char[] tokenFalse = PdfBoolean.FALSE.toCharArray();
    char[] tokenNull = "null".toCharArray();
    char[] tokenTrue = PdfBoolean.TRUE.toCharArray();
    ...
    static /* synthetic */ class C02001 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.parser.CLToken.C02001.<clinit>():void");
        }
    }

    public boolean validate(char c, long j) {
        int i = C02001.$SwitchMap$androidx$constraintlayout$core$parser$CLToken$Type[this.type.ordinal()];
        boolean z = false;
        if (i == 1) {

...
public final class Stopwatch {
    ...
    static /* synthetic */ class C07151 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.test.espresso.core.internal.deps.guava.base.Stopwatch.C07151.<clinit>():void");
        }
    }
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (C07151.$SwitchMap$java$util$concurrent$TimeUnit[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";

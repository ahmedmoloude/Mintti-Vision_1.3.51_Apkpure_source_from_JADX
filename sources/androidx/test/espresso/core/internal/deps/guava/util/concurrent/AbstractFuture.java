...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:3:?, code lost:
            r0 = (sun.misc.Unsafe) java.security.AccessController.doPrivileged(new androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture.UnsafeAtomicHelper.C07591());
         */
        ...
        static {
            /*
                ...
                goto L_0x0010
            L_0x0005:
                androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture$UnsafeAtomicHelper$1 r0 = new androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture$UnsafeAtomicHelper$1     // Catch:{ PrivilegedActionException -> 0x0062 }
            ...
            L_0x0010:
                java.lang.Class<androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture> r1 = androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture.class
                ...
                WAITERS_OFFSET = r2     // Catch:{ Exception -> 0x0058 }
                java.lang.String r2 = "listeners"
                java.lang.reflect.Field r2 = r1.getDeclaredField(r2)     // Catch:{ Exception -> 0x0058 }
                long r2 = r0.objectFieldOffset(r2)     // Catch:{ Exception -> 0x0058 }
                LISTENERS_OFFSET = r2     // Catch:{ Exception -> 0x0058 }
                ...
                VALUE_OFFSET = r1     // Catch:{ Exception -> 0x0058 }
                java.lang.Class<androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture$Waiter> r1 = androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture.Waiter.class
                java.lang.String r2 = "thread"
                java.lang.reflect.Field r1 = r1.getDeclaredField(r2)     // Catch:{ Exception -> 0x0058 }
                long r1 = r0.objectFieldOffset(r1)     // Catch:{ Exception -> 0x0058 }
                WAITER_THREAD_OFFSET = r1     // Catch:{ Exception -> 0x0058 }
                java.lang.Class<androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture$Waiter> r1 = androidx.test.espresso.core.internal.deps.guava.util.concurrent.AbstractFuture.Waiter.class
                java.lang.String r2 = "next"
                java.lang.reflect.Field r1 = r1.getDeclaredField(r2)     // Catch:{ Exception -> 0x0058 }
                long r1 = r0.objectFieldOffset(r1)     // Catch:{ Exception -> 0x0058 }
                WAITER_NEXT_OFFSET = r1     // Catch:{ Exception -> 0x0058 }
                UNSAFE = r0     // Catch:{ Exception -> 0x0058 }
                return
            L_0x0058:
                r0 = move-exception
    ...
    /* JADX WARNING: type inference failed for: r0v5, types: [androidx.test.espresso.core.internal.deps.guava.util.concurrent.ListenableFuture, androidx.test.espresso.core.internal.deps.guava.util.concurrent.ListenableFuture<? extends V>] */

...
import org.greenrobot.greendao.p039rx.RxQuery;
...
public class QueryBuilder<T> {
    ...
    public QueryBuilder<T> whereOr(WhereCondition whereCondition, WhereCondition whereCondition2, WhereCondition... whereConditionArr) {
        this.whereCollector.add(mo34939or(whereCondition, whereCondition2, whereConditionArr), new WhereCondition[0]);
        return this;
    }

    /* renamed from: or */
    public WhereCondition mo34939or(WhereCondition whereCondition, WhereCondition whereCondition2, WhereCondition... whereConditionArr) {
    ...
    private void checkLog(String str) {
        if (LOG_SQL) {
            DaoLog.m1113d("Built SQL for query: " + str);
        }
        if (LOG_VALUES) {
            DaoLog.m1113d("Values for query: " + this.values);
        }
    }

...
import org.hamcrest.core.C2623Is;
...
public class Matchers {
    ...
    /* renamed from: is */
    public static <T> Matcher<T> m1139is(T t) {
        return C2623Is.m1144is(t);
    }

    /* renamed from: is */
    public static <T> Matcher<T> m1140is(Matcher<T> matcher) {
        return C2623Is.m1145is(matcher);
    }

    /* renamed from: is */
    public static <T> Matcher<T> m1138is(Class<T> cls) {
        return C2623Is.m1143is(cls);
    }

    public static <T> Matcher<T> isA(Class<T> cls) {
        return C2623Is.isA(cls);
    }

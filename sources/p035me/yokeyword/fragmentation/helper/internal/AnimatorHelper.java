...
/* renamed from: me.yokeyword.fragmentation.helper.internal.AnimatorHelper */
public final class AnimatorHelper {
    ...
    public Animation getNoneAnim() {
        if (this.noneAnim == null) {
            this.noneAnim = AnimationUtils.loadAnimation(this.context, C2466R.C2467anim.no_anim);
        }
    ...
    private Animation initEnterAnim() {
        if (this.fragmentAnimator.getEnter() == 0) {
            this.enterAnim = AnimationUtils.loadAnimation(this.context, C2466R.C2467anim.no_anim);
        } else {
    ...
    private Animation initExitAnim() {
        if (this.fragmentAnimator.getExit() == 0) {
            this.exitAnim = AnimationUtils.loadAnimation(this.context, C2466R.C2467anim.no_anim);
        } else {
    ...
    private Animation initPopEnterAnim() {
        if (this.fragmentAnimator.getPopEnter() == 0) {
            this.popEnterAnim = AnimationUtils.loadAnimation(this.context, C2466R.C2467anim.no_anim);
        } else {
    ...
    private Animation initPopExitAnim() {
        if (this.fragmentAnimator.getPopExit() == 0) {
            this.popExitAnim = AnimationUtils.loadAnimation(this.context, C2466R.C2467anim.no_anim);
        } else {

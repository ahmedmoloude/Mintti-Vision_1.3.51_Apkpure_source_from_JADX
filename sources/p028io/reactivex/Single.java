...
import p028io.reactivex.internal.observers.BiConsumerSingleObserver;
import p028io.reactivex.internal.observers.BlockingMultiObserver;
import p028io.reactivex.internal.observers.ConsumerSingleObserver;
import p028io.reactivex.internal.observers.FutureSingleObserver;
...
import p028io.reactivex.internal.operators.maybe.MaybeFilterSingle;
import p028io.reactivex.internal.operators.maybe.MaybeFromSingle;
import p028io.reactivex.internal.operators.mixed.SingleFlatMapObservable;
...
import p028io.reactivex.internal.operators.single.SingleAmb;
import p028io.reactivex.internal.operators.single.SingleCache;
import p028io.reactivex.internal.operators.single.SingleContains;
import p028io.reactivex.internal.operators.single.SingleCreate;
import p028io.reactivex.internal.operators.single.SingleDefer;
import p028io.reactivex.internal.operators.single.SingleDelay;
import p028io.reactivex.internal.operators.single.SingleDelayWithCompletable;
import p028io.reactivex.internal.operators.single.SingleDelayWithObservable;
import p028io.reactivex.internal.operators.single.SingleDelayWithPublisher;
import p028io.reactivex.internal.operators.single.SingleDelayWithSingle;
import p028io.reactivex.internal.operators.single.SingleDematerialize;
import p028io.reactivex.internal.operators.single.SingleDetach;
import p028io.reactivex.internal.operators.single.SingleDoAfterSuccess;
import p028io.reactivex.internal.operators.single.SingleDoAfterTerminate;
import p028io.reactivex.internal.operators.single.SingleDoFinally;
import p028io.reactivex.internal.operators.single.SingleDoOnDispose;
import p028io.reactivex.internal.operators.single.SingleDoOnError;
import p028io.reactivex.internal.operators.single.SingleDoOnEvent;
import p028io.reactivex.internal.operators.single.SingleDoOnSubscribe;
import p028io.reactivex.internal.operators.single.SingleDoOnSuccess;
import p028io.reactivex.internal.operators.single.SingleDoOnTerminate;
import p028io.reactivex.internal.operators.single.SingleEquals;
import p028io.reactivex.internal.operators.single.SingleError;
import p028io.reactivex.internal.operators.single.SingleFlatMap;
import p028io.reactivex.internal.operators.single.SingleFlatMapCompletable;
import p028io.reactivex.internal.operators.single.SingleFlatMapIterableFlowable;
import p028io.reactivex.internal.operators.single.SingleFlatMapIterableObservable;
import p028io.reactivex.internal.operators.single.SingleFlatMapMaybe;
import p028io.reactivex.internal.operators.single.SingleFlatMapPublisher;
import p028io.reactivex.internal.operators.single.SingleFromCallable;
import p028io.reactivex.internal.operators.single.SingleFromPublisher;
import p028io.reactivex.internal.operators.single.SingleFromUnsafeSource;
import p028io.reactivex.internal.operators.single.SingleHide;
import p028io.reactivex.internal.operators.single.SingleInternalHelper;
import p028io.reactivex.internal.operators.single.SingleJust;
import p028io.reactivex.internal.operators.single.SingleLift;
import p028io.reactivex.internal.operators.single.SingleMap;
import p028io.reactivex.internal.operators.single.SingleMaterialize;
import p028io.reactivex.internal.operators.single.SingleNever;
import p028io.reactivex.internal.operators.single.SingleObserveOn;
import p028io.reactivex.internal.operators.single.SingleOnErrorReturn;
import p028io.reactivex.internal.operators.single.SingleResumeNext;
import p028io.reactivex.internal.operators.single.SingleSubscribeOn;
import p028io.reactivex.internal.operators.single.SingleTakeUntil;
import p028io.reactivex.internal.operators.single.SingleTimeout;
import p028io.reactivex.internal.operators.single.SingleTimer;
import p028io.reactivex.internal.operators.single.SingleToFlowable;
import p028io.reactivex.internal.operators.single.SingleToObservable;
import p028io.reactivex.internal.operators.single.SingleUnsubscribeOn;
import p028io.reactivex.internal.operators.single.SingleUsing;
import p028io.reactivex.internal.operators.single.SingleZipArray;
import p028io.reactivex.internal.operators.single.SingleZipIterable;
...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @SchedulerSupport("none")
    /* renamed from: as */
    public final <R> R mo29670as(SingleConverter<T, ? extends R> singleConverter) {
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo29745to(Function<? super Single<T>, R> function) {
        try {

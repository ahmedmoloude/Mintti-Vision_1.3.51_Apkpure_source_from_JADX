...
public final class ObservableRefCount<T> extends Observable<T> {
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        synchronized (this) {
            ...
            z = true;
            if (refConnection.connected || j2 != ((long) this.f2078n)) {
                z = false;
            } else {
    ...
    public void cancel(p028io.reactivex.internal.operators.observable.ObservableRefCount.RefConnection r6) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x003f:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p028io.reactivex.internal.operators.observable.ObservableRefCount.cancel(io.reactivex.internal.operators.observable.ObservableRefCount$RefConnection):void");
    }

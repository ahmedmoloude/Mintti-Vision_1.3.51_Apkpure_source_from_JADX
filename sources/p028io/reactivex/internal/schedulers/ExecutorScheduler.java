...
public final class ExecutorScheduler extends Scheduler {
    ...
    public static final class ExecutorWorker extends Scheduler.Worker implements Runnable {
        ...
        public void run() {
            ...
            L_0x0025:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p028io.reactivex.internal.schedulers.ExecutorScheduler.ExecutorWorker.run():void");
        }
    ...
    final class DelayedDispose implements Runnable {
        ...
        /* renamed from: dr */
        private final DelayedRunnable f2100dr;

        DelayedDispose(DelayedRunnable delayedRunnable) {
            this.f2100dr = delayedRunnable;
        }

        public void run() {
            this.f2100dr.direct.replace(ExecutorScheduler.this.scheduleDirect(this.f2100dr));
        }
    }
}

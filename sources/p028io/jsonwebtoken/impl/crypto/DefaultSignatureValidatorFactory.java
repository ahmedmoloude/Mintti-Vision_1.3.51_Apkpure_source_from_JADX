...
public class DefaultSignatureValidatorFactory implements SignatureValidatorFactory {
    ...
    public SignatureValidator createSignatureValidator(SignatureAlgorithm signatureAlgorithm, Key key) {
        ...
        switch (C24231.$SwitchMap$io$jsonwebtoken$SignatureAlgorithm[signatureAlgorithm.ordinal()]) {
            case 1:
            case 2:
            case 3:
    ...
    static /* synthetic */ class C24231 {
        ...
        static {
            ...
            L_0x0090:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p028io.jsonwebtoken.impl.crypto.DefaultSignatureValidatorFactory.C24231.<clinit>():void");
        }
    }
}

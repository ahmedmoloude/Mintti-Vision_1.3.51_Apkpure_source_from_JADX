...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    private static final byte[] DIGITS = {ByteBuffer.ZERO, 49, 50, 51, 52, 53, 54, 55, 56, 57, 97, 98, 99, 100, 101, 102};
    ...
    public int readInt() {
        if (this.size >= 4) {
            ...
            int i2 = segment.limit;
            if (i2 - i < 4) {
                return ((readByte() & UByte.MAX_VALUE) << 24) | ((readByte() & UByte.MAX_VALUE) << BidiOrder.f527S) | ((readByte() & UByte.MAX_VALUE) << 8) | (readByte() & UByte.MAX_VALUE);
            }
            byte[] bArr = segment.data;
            int i3 = i + 1;
            int i4 = i3 + 1;
            byte b = ((bArr[i] & UByte.MAX_VALUE) << 24) | ((bArr[i3] & UByte.MAX_VALUE) << BidiOrder.f527S);
            int i5 = i4 + 1;
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m1109of(instance.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m1109of(instance.doFinal());
        } catch (NoSuchAlgorithmException unused) {
            throw new AssertionError();

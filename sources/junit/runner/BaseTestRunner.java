...
public abstract class BaseTestRunner implements TestListener {
    ...
    protected static Properties getPreferences() {
        if (fPreferences == null) {
            ...
            fPreferences = properties;
            properties.put("loading", PdfBoolean.TRUE);
            fPreferences.put("filterstack", PdfBoolean.TRUE);
            readPreferences();
        }
        return fPreferences;
    }
    ...
    public boolean useReloadingTestSuiteLoader() {
        return getPreference("loading").equals(PdfBoolean.TRUE) && this.fLoading;
    }
    ...
    protected static boolean showStackRaw() {
        return !getPreference("filterstack").equals(PdfBoolean.TRUE) || !fgFilterStack;
    }

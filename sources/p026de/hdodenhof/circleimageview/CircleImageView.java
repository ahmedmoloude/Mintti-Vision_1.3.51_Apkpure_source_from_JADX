package p026de.hdodenhof.circleimageview;
...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBorderWidth = 0;
        this.mCircleBackgroundColor = 0;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2415R.styleable.CircleImageView, i, 0);
        this.mBorderWidth = obtainStyledAttributes.getDimensionPixelSize(C2415R.styleable.CircleImageView_civ_border_width, 0);
        this.mBorderColor = obtainStyledAttributes.getColor(C2415R.styleable.CircleImageView_civ_border_color, -16777216);
        this.mBorderOverlay = obtainStyledAttributes.getBoolean(C2415R.styleable.CircleImageView_civ_border_overlay, false);
        if (obtainStyledAttributes.hasValue(C2415R.styleable.CircleImageView_civ_circle_background_color)) {
            this.mCircleBackgroundColor = obtainStyledAttributes.getColor(C2415R.styleable.CircleImageView_civ_circle_background_color, 0);
        } else if (obtainStyledAttributes.hasValue(C2415R.styleable.CircleImageView_civ_fill_color)) {
            this.mCircleBackgroundColor = obtainStyledAttributes.getColor(C2415R.styleable.CircleImageView_civ_fill_color, 0);
        }
